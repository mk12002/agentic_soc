...
let TOKEN=localStorage.getItem('soc_token')||'';const TABS=['Cases','Approvals','Vulnerabilities','Phishing','Connectors','Policy','Audit'];let tab='Cases';
...
function show(t){tab=t;document.querySelectorAll('#nav button').forEach(b=>b.classList.toggle('on',b.textContent==t));({Cases,Approvals,Vulnerabilities,Phishing,Connectors,Policy,Audit})[t]()}
...
const ALLOWED={act,apol,ask,camp,caseView,decide,dl,kill,login,rep,runInc,runPh,show,upl,vmRefresh};
